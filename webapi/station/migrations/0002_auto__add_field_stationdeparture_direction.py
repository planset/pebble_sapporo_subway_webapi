...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StationDeparture.direction'
        db.add_column(u'station_stationdeparture', 'direction',
                      self.gf('django.db.models.fields.CharField')(default='fukuzumi', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StationDeparture.direction'
        db.delete_column(u'station_stationdeparture', 'direction')
